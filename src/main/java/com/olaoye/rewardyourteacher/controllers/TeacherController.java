package com.olaoye.rewardyourteacher.controllers;
...
import com.olaoye.rewardyourteacher.utils.ErrorsMap;
...
public class TeacherController {
    ...
    @GetMapping("find-students/{studentId}")
    @PreAuthorize("hasAuthority('ROLE_TEACHER')")
    public ResponseEntity<APIResponse<StudentResponseDTO>>findStudent(
        ...
        try {
            ...
            StudentResponseDTO studentResponseDTO  = teacherService.findStudent(studentId);
            APIResponse<StudentResponseDTO> response = new APIResponse<>(true, "success", studentResponseDTO);
            return new ResponseEntity<>(response, HttpStatus.OK);
        } catch (Exception ex) {
            return new ResponseEntity<>(new APIResponse<>(false, ex.getMessage(), null), HttpStatus.BAD_REQUEST);
        }
